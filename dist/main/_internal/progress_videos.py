...
class Process1Logo:
    def __init__(self, window_father) -> None:
        ...
        self.__spinner.title("Creando video...")
        ...
        ttk.Label(self.__spinner, text="Añadiendo logo al video...").pack(pady=10)
...
class Process2Final:
    def __init__(self, window_father) -> None:
        ...
        ttk.Label(self.__spinner, text="Generando video final...").pack(pady=10)
